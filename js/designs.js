...
console.log('Thanks for checking out the code for my website! You can get a full detailed view at https://github.com/GeorgeBelanger/designs-site. I didnt make the entire site myself, but I did rip through it to get it personalized which took an indepth knowledge of html, css, JS and Three.js. Darn Samesite attribute warnings! Also havent yet set up a remote logger for errors, so if you see anything Id appreciate the feedback!')
...
function init() {
  ...
  var particleAnimation = createParticleAnimation();
  root.scene.add(textAnimation);
  root.scene.add(particleAnimation);
